...
const API = (() => {
    ...
    return {
        ...
        projetos: {
            ...
            cancelar:  (id, data) => request('POST', `/api/projetos/${id}/cancelar`, data || {}),
            pausar:    (id, data) => request('POST', `/api/projetos/${id}/pausar`, data || {}),
            reativar:  (id, data) => request('POST', `/api/projetos/${id}/reativar`, data || {}),
            despausar: (id, data) => request('POST', `/api/projetos/${id}/despausar`, data || {}),
            retornar:  (id, data) => request('POST', `/api/projetos/${id}/retornar`, data || {}),
